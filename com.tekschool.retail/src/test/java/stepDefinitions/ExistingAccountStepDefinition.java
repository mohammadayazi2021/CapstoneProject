...
public class ExistingAccountStepDefinition extends Base {
	...
	@When("^User enter on emailaddress 'anas_ayazi@yahoo\\.com' and password 'Mudasir@(\\d+)'$")
	public void user_enter_on_emailaddress_anas_ayazi_yahoo_com_and_password_Mudasir(int arg1) throws Throwable {
